...
export default class RidersList extends Component {  
    ...
    async componentDidMount () { 
         ...
         var Riders = _.filter(InviList, {  'Role': 'Car_Customers'  });
        ...
        <SafeAreaView style = {styles.container}>
         <ScrollView style = {styles.scrollView} >
             ...
             {this.state.RidersList.map(Rider => {
                 return (
                     <TouchableOpacity key= {Rider.Email}  >
                  <View >
                 ...
                 <Text style = {styles.ListText} >{Rider.Name}</Text>  
                       ...
                       <TouchableOpacity   style = {styles.InviteBtn}  >
                       <Button color = {"lightgray"} title = "Invite" onPress = {() => {this.props.Invite(Rider.Email , Rider)}} />
                       </TouchableOpacity> 
